...
parser.add_argument('source', help='The source file(s) or directory', required=True)
...
parser.add_argument('-d', '--format', action='dt_format',
                    help='specify datetime format default %Y-%m-%d-%H-%M, uses datetime formatting',
                    default='%Y-%m-%d-%H-%M', required=False)
